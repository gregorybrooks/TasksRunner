...
cp ${EVENT_EXTRACTOR_FILES_DIRECTORY}/${SUBMISSION_ID}.${NAME}.json ${APP_DIR}/test_data.bp.json
...
mv ${APP_DIR}/results.json ${EVENT_EXTRACTOR_FILES_DIRECTORY}/${SUBMISSION_ID}.${NAME}.results.json
